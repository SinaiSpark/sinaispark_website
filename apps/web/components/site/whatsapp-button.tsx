...
/**
 * Global WhatsApp click-to-chat float.
 *
 * Visible on every page once the user scrolls past the page top; on the Home
 * page it stays hidden while the full-height hero is on screen and fades in
...
export function WhatsAppButton({ className, message }: WhatsAppButtonProps) {
  ...
  useEffect(() => {
    ...
    // Home hero spans ~70–85svh; crossing 90% of the viewport clears it.
    const threshold = () => (isHome ? window.innerHeight * 0.9 : 240)
